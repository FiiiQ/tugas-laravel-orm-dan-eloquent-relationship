    ...
    <div class="container">
        <div class="row">
            <div class="d-flex justify-content-center">
                <a href="{{ route('admin.index', ['user' => $user->id]) }}" class="btn btn-md btn-success mt-3">Kembali
                    ke Halaman Admin</a>
            </div>
            <div class="col-md-5 offset-1 rounded my-lg-5 px-3 py-3 me-3" style="border: 3px solid black">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <p class="">{{ $user->umur }} tahun</p>
                        <p class="">{{ $user->tanggal_lahir }}</p>
            ...
            <div class="col-md-5 rounded my-lg-5 px-3 py-3" style="border: 3px solid black">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <p class="">{{ $user->summarize->nama_toko }}</p>
                        <p class="">{{ $user->summarize->rate }}</p>
                        <p class="">{{ $user->summarize->produk_terbaik }}</p>
                        <p class="">{{ $user->summarize->deskripsi }}</p>
                    </div>
                </div>
            </div>
        </div>
