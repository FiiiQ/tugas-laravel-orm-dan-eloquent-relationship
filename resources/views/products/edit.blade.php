    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 offset-4 rounded bg-info mt-3 py-3">
                ...
                <form class="mt-3" action="{{ route('products.update', ['product' => $product->id, 'user' => $user->id]) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                    <div class="mb-1">
                        <label for="exampleFormControlInput1" class="form-label fw-semibold">Gambar Produk</label>
                        <input type="text" class="form-control" name="gambar" placeholder="Masukkan gambar produk"
